...
module.exports = async (ctx) => {
  try {
    ...
    stats.profits_not_payed_sum = !stats.profits_not_payed_sum ? 0 : stats.profits_not_payed_sum;
    stats.profits_payed_sum = !stats.profits_payed_sum ? 0 : stats.profits_payed_sum;
